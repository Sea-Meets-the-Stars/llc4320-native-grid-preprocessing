...
from dbof.global_dataset_creation.iterations import mit_date_to_iteration
...
def main(
    ...
    .. deprecated::
        Use ``generate_global_GEN.main()`` with ``pipeline='DEPTH'`` instead.
    """
    import warnings
    warnings.warn(
        "generate_global_depth.py (DEPTH) is deprecated.  "
        "Use generate_global_GEN.py with pipeline='DEPTH' instead.",
        DeprecationWarning,
        stacklevel=2,
    )
