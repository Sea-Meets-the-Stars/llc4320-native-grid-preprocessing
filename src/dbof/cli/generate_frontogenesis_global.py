...
def process_time_snapshot(
    ...
    # Compute all frontogenesis-derived properties from a single pass
    frontogenesis_props = calculate_additional_fields.all_frontogenesis_properties(ds_merge, grid)
