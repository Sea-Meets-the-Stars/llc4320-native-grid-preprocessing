...
CHECKS_SRC["frontal_structure"] = """\
    "gradtheta2 = dTheta_dx^2 + dTheta_dy^2":
        (_gs("gradtheta2"),
         _gs("dTheta_dx")**2 + _gs("dTheta_dy")**2),
    "gradsalt2 = dSalt_dx^2 + dSalt_dy^2":
        (_gs("gradsalt2"),
         _gs("dSalt_dx")**2 + _gs("dSalt_dy")**2),
    "gradeta2 = dEta_dx^2 + dEta_dy^2":
        (_gs("gradeta2"),
         _gs("dEta_dx")**2 + _gs("dEta_dy")**2),
    "gradrho2 = drho_dx^2 + drho_dy^2":
        (_gs("gradrho2"),
         _gs("drho_dx")**2 + _gs("drho_dy")**2),
    "gradb2 = db_dx^2 + db_dy^2":
        (_gs("gradb2"), _gs("db_dx")**2 + _gs("db_dy")**2),
