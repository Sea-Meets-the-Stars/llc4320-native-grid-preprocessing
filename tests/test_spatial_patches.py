"""Unit tests for spatial_patches extent helpers on the stitched (j, i) grid."""
import numpy as np

from dbof.cutout_dataset_creation.spatial_patches import (
    extent_in_i, extent_in_j, get_lat_lon_extents_of_patch,
)
...
def test_get_extents_symmetric_centered():
    ...
    patch = get_lat_lon_extents_of_patch((15, 15), dxC, dyC, (31, 31), km_size=6.0)
...
def test_get_extents_rejects_off_edge():
    dxC = dyC = _uniform(31, 31)
    assert get_lat_lon_extents_of_patch((15, 0), dxC, dyC, (31, 31), km_size=6.0) is None
...
def test_get_extents_nonuniform_exact():
    ...
    patch = get_lat_lon_extents_of_patch((2, 2), dxC, dyC, (6, 6), km_size=14.0)
